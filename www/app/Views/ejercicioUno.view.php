<div class="row">
    <div class="col-12">
        <div class="card shadow mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nombre" id="alias" value="" />
                            </div>
                        </div>
            ...
            <p><?php echo isset($_POST['nombre']) ? "Hola " . $_POST["nombre"] . " , es un placer conocerte!" : 'Hola, inserta tu nombre porfavor.' ?></p>
        </div>
    </div>